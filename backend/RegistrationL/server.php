...
//$db = mysqli_connect('localhost', 'root', '', 'resource_hub');
...
if (isset($_POST['reg_user'])) {
  ...
  $yeargroup = mysqli_real_escape_string($db, $_POST['yeargroup']);
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (fullname, email, yeargroup, major, password) 
